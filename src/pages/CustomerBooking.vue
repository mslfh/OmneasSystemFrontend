<template>
  <q-page class="q-pa-sm q-ma-md">
    ...
    <q-breadcrumbs class="text-grey q-pb-md" gutter="2px" active-color="purple">
      <template v-slot:separator>
        <q-icon size="1.2em" name="arrow_forward" color="grey" />
      </template>

      <q-breadcrumbs-el label="Service" icon="check_circle" />
      <q-breadcrumbs-el label="Time" icon="widgets" />
    </q-breadcrumbs>
          ...
          >
            ...
            <div class="q-pa-md-md q-pa-none-xs q-gutter-md">
              ...
              <div class="row q-pa-md-md q-pa-none-xs">
                ...
                <q-chip v-for="staff in availableStaff" clickable @click=" () => {
...
onMounted(async () => {
  try {
    var response = await axios.get(
      VITE_API_URL + "/api/packages-with-service"
    );
    packages.value = response.data;

    response = await axios.get(
      VITE_API_URL + "/api/get-available-shedules"
    );
